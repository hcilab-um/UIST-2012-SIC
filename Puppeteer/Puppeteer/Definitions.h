...
#define FIVE_FINGERS_LEFT 2700//2900
...
#define MIN_SPEED_LEVEL -3
#define LEG_MAX_TICKS 300
#define HAND_MAX_TICKS 350
#define HEAD_MAX_TICKS 150
#define THRESHOLD_TICKS 30	//less than x ticks should not move servo from current position
#define STOPPING_TICKS 1
...
enum handLocation{
	...
	eCenter = 0,
	eRight = 1
>>>>>>> b0dde89c31b77a8024638c3220765830b229379e
};